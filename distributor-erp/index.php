...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
        ...
        <div class="px-6 py-3 bg-gray-50 border-t border-gray-100">
            <a href="modules/reports/low_stock.php" class="text-orange-600 hover:text-orange-700 text-sm font-medium inline-flex items-center">
                Review inventory
                <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                </svg>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="space-y-3">
            <a href="modules/bookings/add.php" class="flex items-center justify-between p-4 bg-blue-50 hover:bg-blue-100 border border-blue-100 rounded-lg transition-colors duration-150 group">
        ...
        <div class="p-6">
            ...
            <?php else: ?>
                <div class="text-center py-8">
                    ...
                    <a href="modules/bookings/add.php" class="mt-3 inline-flex items-center text-sm text-blue-600 hover:text-blue-700 font-medium">
