                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="flex items-center gap-3">
                                    <a href="print_invoice.php?id=<?php echo $purchase['id']; ?>" class="text-blue-600 hover:text-blue-900">Print</a>
                                    <?php if (canEdit($conn, $_SESSION['role'], 'purchases')): ?>
                                        <a href="edit.php?id=<?php echo $purchase['id']; ?>" class="text-yellow-600 hover:text-yellow-900">Edit</a>
                                    <?php endif; ?>
                                    <?php if (canDelete($conn, $_SESSION['role'], 'purchases')): ?>
                                        <a href="delete.php?id=<?php echo $purchase['id']; ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Are you sure you want to delete this purchase? This will adjust inventory.');">Delete</a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
